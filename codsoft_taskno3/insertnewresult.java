...
public class insertnewresult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setText("Updates Student Details");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
               st.executeUpdate("insert into result (rollno,physics,chemistry,mathematic,electrical,english) "
                   + "values('"+rollno+"','"+physics+"','"+chemistry+"','"+mathematic+"','"+electrical+"','"+english+"')");
